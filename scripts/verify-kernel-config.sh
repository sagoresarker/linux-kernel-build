...
check_option CRITICAL CONFIG_NFT_COUNTER             y "nftables counter expression"
check_option CRITICAL CONFIG_NFT_CT                  y "nftables conntrack"
check_option CRITICAL CONFIG_NFT_NAT                 y "nftables NAT"
check_option CRITICAL CONFIG_NFT_CHAIN_NAT           y "nftables NAT chain"
...
check_option RECOMMENDED CONFIG_BPF_JIT_DEFAULT_ON   y "BPF JIT default on"
